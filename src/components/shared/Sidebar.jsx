...
export default function Sidebar() {
  return (
    <aside
      className="w-48 shrink-0 flex flex-col py-4"
    ...
    >
        ...
        <div className="flex flex-col gap-1">
          {AGENTS.map((a) => (
            <div key={a.label} className="flex flex-col px-3 py-2"
              ...
              <span className="text-[9px] tracking-wider mt-0.5" style={{ color: T.text.micro }}>
                /{a.sub}
              </span>
            </div>
          ))}
      ...
      <div className="mt-auto px-4 pt-4" style={{ borderTop: `1px solid ${T.border.subtle}` }}>
        ...
        <p className="text-[9px] mt-0.5" style={{ color: T.text.micro }}>v0.2.0-alpha</p>
      </div>
    </aside>
  );
}